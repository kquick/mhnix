# let devnix = builtins.fetchTarball { url = https://api.github.com/repos/kquick/devnix/tarball; }; in
let devnix = /home/kquick/Projects/devnix; in
with (import devnix);
...
, pkgs ? defaultPkgs nixpkgs system pkgOverrides freshHaskellHashes
